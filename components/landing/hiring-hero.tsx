...
export function HiringHero() {
  return (
    <section className="relative w-full overflow-hidden bg-[#EEF2FF] pb-4 sm:pb-6">
      <div className="relative mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div className="relative w-full">
          ...
          <div className="pointer-events-none absolute left-0 top-0 h-[28%] w-[58%] bg-gradient-to-br from-[#EEF2FF] from-55% via-[#EEF2FF]/80 to-transparent sm:w-[50%] lg:w-[44%]" />

          <div className="absolute inset-0 flex flex-col justify-between">
            <div className="z-10 w-full max-w-[48%] px-[2%] pt-[2.5%] sm:max-w-[46%] sm:pt-[3%] lg:max-w-[44%] lg:pt-[3.5%]">
            ...
            <div className="z-20 w-full max-w-[48%] px-[2%] pb-[1.5%] sm:max-w-[46%] sm:pb-[2%] lg:max-w-[44%] lg:pb-[2.5%]">
